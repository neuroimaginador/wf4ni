...
```{r echo = FALSE}
readRDS(file = "./resources/volumetry/brain_volume.rds")
```
...
```{r echo = FALSE}
readRDS(file = "./resources/volumetry/basic_volumetry.rds")
```
...
```{r echo = FALSE}
readRDS(file = "./resources/volumetry/final_volumetry.rds")
```
...
lines <- readLines(con = "./resources/volumetry/log.txt")
