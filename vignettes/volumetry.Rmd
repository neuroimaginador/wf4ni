...
make_brain_extraction <- function(image, template_images, template_structs) {

  res <- malf(infile = image,
...
template_images <- list.files(path = file.path(template_folder,
                                               "images"),
                              pattern = ".nii.gz")
template_structs <- list.files(path = file.path(template_folder,
                                               "masks"),
                              pattern = ".nii.gz")
```
