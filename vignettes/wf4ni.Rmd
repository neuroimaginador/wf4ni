---
title: "Reproducible and Shareable Neuroimaging Pipelines: The `wf4ni` package"
author: "Domingo López-Rodríguez"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Reproducible and Shareable Neuroimaging Pipelines: The `wf4ni` package}
...
Original inputs in the _flow_ are _I1_, _I2_ and _I3_ (in green). Other nodes represent the output of a given function, using the incident nodes as inputs for that function.
