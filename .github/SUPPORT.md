# Getting help with wf4ni

Thanks for using wf4ni. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/wf4ni/issues) to make sure the 
